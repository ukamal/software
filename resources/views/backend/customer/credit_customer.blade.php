    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Credit Customer</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    ...
                                    <a target="_blank" href="{{ route('credit-customer-pdf') }}" class="btn btn-primary float-sm-right"> <i class="fa fa-download"></i> Download PDF</a>
                                ...
                                <tbody>
                                    @foreach($allData as $key => $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Edit" href="{{route('customer_edit_invoice',$payment->invoice_id)}}" class="btn btn-sm btn-primary">
